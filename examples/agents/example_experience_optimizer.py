...
from src.agents.experience_optimizer_agent import (  # noqa: E402
...
def main():
    ...
    try:
        ...
        print("  Task: optimize_experience_section_task")
    ...
    print_section(
        ...
        "Retrieving validated OptimizedExperienceSection object...",
    )
