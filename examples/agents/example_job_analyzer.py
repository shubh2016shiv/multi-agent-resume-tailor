...
from examples.agents.common import get_job_desc_md  # noqa: E402
from src.agents.job_analyzer_agent import (  # noqa: E402
...
def main():
    ...
    try:
        ...
        if validated_job:
            ...
            should_have = [
                r for r in validated_job.requirements if r.importance.value == "should_have"
            ]
            nice_to_have = [
                r for r in validated_job.requirements if r.importance.value == "nice_to_have"
            ]
