...
def create_mock_tailored_resume():
    ...
    return {
        ...
        "skills": [
            ...
            "CI/CD", "Jenkins", "Git", "Agile", "Microservices"
        ]
    }
...
def create_mock_job_description():
    ...
    return {
        ...
        "keywords": [
            "Python", "AWS", "Kubernetes", "Docker", "CI/CD", "Microservices",
            "Leadership", "Agile", "PostgreSQL", "Redis", "Team Lead"
        ]
    }
...
def main():
    ...
    try:
        ...
        print(f"  Task: quality_assurance_task")
