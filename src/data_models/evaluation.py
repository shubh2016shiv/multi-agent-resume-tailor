    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "missed_requirements": [
                    "Did not emphasize experience with Agile methodologies, which was a preferred skill."
                ],
...
class QualityReport(BaseModel):
    ...
    overall_quality_score: float = Field(
        ..., ge=0, le=100, description="The final, weighted quality score (0-100)."
    )
        ...
        json_schema_extra = {
            "example": {
                ...
                "relevance": {
                    ...
                    "must_have_skills_coverage": 100.0,
                    "missed_requirements": [],
                    "justification": "Excellent alignment with job needs.",
                },
                "ats_optimization": {
                    "ats_score": 85.0,
