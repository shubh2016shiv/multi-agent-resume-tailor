...
def _convert_pdf_with_fallback(path: Path) -> str:
    ...
    try:
        ...
        raise OSError(full_error) from e
...
def _convert_docx_with_python_docx(path: Path) -> str:
    ...
    try:
        ...
        raise ImportError(
            "python-docx is not installed. Install with: uv pip install python-docx"
        ) from e
...
def get_available_converters() -> dict[str, bool]:
    ...
    # Check for Docling
    try:
        # import docling  # Commented out: unused import
    ...
    # Check for PyPDF2
    try:
        # import PyPDF2  # Commented out: unused import
    ...
    try:
        # import docx  # Commented out: unused import
